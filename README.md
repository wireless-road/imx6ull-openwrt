...
**1.** Установите ситемы утилиты сборки для вашего дистрибутива. Для Ubuntu в консоли выполните команды:
> sudo apt-get update
...
**4.** Установите для выбора все доступные пакеты командами:
